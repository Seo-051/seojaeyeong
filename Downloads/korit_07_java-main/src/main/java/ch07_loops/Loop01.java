...
/*
    ...
    while 뒤에 나오는 (조건식)을 봤을때 if(조건식) 형태와 유사합니다.
...
//        System.out.println(sum);
        ...
        /*
            사실 1부터 1 씩 증가하는 합 공식은 while 반복문을 쓰는 것 자체가
            오히려 비효율적이라는 사실을 이상의 48~49 라인에서 확인할 수 있습니다.

            하지만 whuke문 자체는 Java 문법이고, if에서와 동일하게
            중첩적으로 사용이 가능합니다.
