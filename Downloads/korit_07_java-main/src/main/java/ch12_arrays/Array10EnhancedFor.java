...
/*
    ...
    일반 for문과 차이점 :
        ...
        arr01.length와 같은 방식으호 일종의 field 참조를 통해 int 값을 추출하여
        대입해야만 했습니다.

        그런데 잘 생각해보면 for(int i=0; ..) 부분에서 int i는
        for문 내부에서 선언되고, 내부에서만 사용이 가능합니ㅏㄷ.
...
public class Array10EnhancedFor {
    public static void main(String[] args) {
        ...
        for(int number : nums){ // int[]
            ...
            // 그 다음 반복으로 넘어가서 nums의 두번째 element인 2를 number에 대입
            // 39번 실행
            // 다음 3 대입
            // 39 실행
            // .. 200 대입
            // 39번 라인 실행 하고, 마무리(마무리 시점은 마지막 element 대입루
            // 반복 실행문 실행 후)
            // 이후에 반복문 바깥에서느 int i 와 동일하게
...
/*
    개발자들이 자기가 일일이 코드 치는 경우도 많겠지만 남의 거 보고 수정하거나 유지보수하는 일도 많음
 */