...
public class CalculatorMain {
    ...
    public static void main(String[] args) {
        // interface Calculator를 사용할거임
        // 근데 인터페이스 내부에는 두개의 매개변수만 정의 되었습니다.
        ...
        System.out.println(add.calculate(2, 3));            //15번 라인의 주석을 참고했을때 올바른 메서드 호출 방식
        System.out.println(sub.calculate(2,3));             // 근데 너무 길어서 저희는 static method를 정의했습니다.
        System.out.println("-----static method 호출 방식 결과 ------");
        System.out.println("2 + 3 = " + operate(2,3, add));     // static method의 오직
        // 세번째 매개변수로 Calculator 인터페이스의 서브 클래스를 받습니다.
        // 그리고 return 문을 보시면 해당 객체의 .calculate() 메서드를 호출하는 것을 확인할 수 있습니다.
        // 근데 add.calculate()는 return이 x + y니까 결과값이 5가 나옴
        // 그러면 우리는 24번 코드 라인의 해석을 위해서
        // Calculator 인터페이스와, CalculatorMain의 staitc method와, 그라고 main에서의 lambda 식을 전부
        // 왔다갔다하면서 볼 필요가 있음.
