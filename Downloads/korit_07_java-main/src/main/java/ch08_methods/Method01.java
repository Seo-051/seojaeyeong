...
public class Method01 {
    /*
        여기에 메서드를 정의 할 예정
        이번 수업 이후로 부터는 꼭 main을 치지 않는 경우도 있다는 점을 아시면 되겠습니다
     */
    // 메서드 정의 영역
    //1. [ x | x] [ 입력값 / 출력값]
    public  static void call1(){
        System.out.println("[ x | x ]");
        //System.out.println("똑같은 말");
    }
    ...
    public static void call2(String example){
        ...
        // void(비어있다) = return 값이 없다
    }

    //3. [ x | o ]
    public static String call3(){
        String example = "안녕하세여";
...
//        System.out.println("[ x | o ]");
//        return 1; // 추가적인 연산을 위해 return을 사용 ex) System.out.println(call3And1()+1);
//    }
    ...
    /*
        return이 있는 이유는 기본적으로 데이터의 조작을 위해서 입니다. 그리고 특정 메서드의 결과값이
        다른 메서드의 argument로 사용될 수도 있습니다.

        함수형 프로그램밍(Functional Programming) : "
            메서드1의 return값이 메서드2의 argument가 되고, 메서드2의 return값이
            메서드3의 argument가 되는 방식으로,

            첫번째 메서드로 부터 마지막 메서드까지의 흐름을 통해 프로그램이 이어지는 코딩 방식
            간단 예시
     */
    ...
    public static void main(String[] args) {
        ...
        myName = scanner.nextLine();             // 사실 이  nextLined이 메서드 임 -> 메서드의 결과값을 myName이라는 변수에 저장
