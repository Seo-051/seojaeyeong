...
/*
    super 키워드
       ...
       자식 클래스의 객체 생성시 필수적으로 '부모 클래스의 생성자를 호출' 하기 때문입니다.

       // 어떤 객체를 생성한다고 가정할 때
       A a = new B();
       같은 형태의 객체 생성 방식이 튀어나오게 되는데(추후 수업 예정)(
       이상의 방식은 정보처리기사에서 단골 문제 입니다.
 */
public class Product extends Item {
    ...
    // 자동완성이 아닌 고유 메서드 하나 임의로 정의하겠습니다.
    public void showInfo(){
        ...
        System.out.println("재고 : " + stock);                    // 두 줄씩 코드 라인 차이가 생기는 이유에 대해 명확히 아시길 추천
    }
}
