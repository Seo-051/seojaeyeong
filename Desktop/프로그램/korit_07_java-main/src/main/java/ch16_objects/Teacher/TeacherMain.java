...
public class TeacherMain {
    public static void main(String[] args) {
        ...
        // 여러분 어느 수준까지 그냥 작성할지, 변수에 대입할지를 조직에 따라,
        // 성향에 따라 결정하셔야 합니다.
        ...
        ch16_objects.Teachers teacher3 = new ch16_objects.Teachers("안근수", "코리아이이티");
        ...
        // ch16_object.teacher.Teacher가 아닙니다.
    }
}
