...
public class Person {
    ...
    // 생성자를 정의하는 방법은 많은데, Lombok을 도입할 수도 있지만 그 경우도
    // 몇번째 argument로 이름을 넣은지, 나이를 넣는지는 골치 아픔
    ...
    public static class Builder{
        ...
        /*
            ...
            설명했었지만, Builder패턴의 경우
            대입될 필드의 이름과 동일한 메서드 명을 짓습니다.
            근데 필그는 명사로 지으니까 명사임
         */

        public Builder name(String name){
            this.name = name;   // 객체가 생성되면 객체의 이름으로 치환되는 키워드
            return this;  // 여태 name에 값이 없다가, 38번 코드라인 시점에 name field에
            // 값이 대입된 객체가 리턴됨
        }
