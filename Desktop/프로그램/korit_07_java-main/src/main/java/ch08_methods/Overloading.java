...
/*
      method overloading
        ...
        overloading의 장점 :
            동일한 기능을 하는 메서드를 정의 할때 메서드 명이 필요한데
            예를 들어 string 자료형끼리 연결해주는 메서드와
            int끼리의 합 연산을 하는 메서드를 나눈다고 가정했을띠
            add
            plus
            connect 등의 메서드를 정의했다면
            다음 합 연산을 하는 (예를 들어 double 자료형을 지니는) 메서드 명을 정하는것이
            번거롭다.
            이러한 부분의 해결을
...
public class Overloading {
    ...
    public static void add(int a, int b){
        ...
        System.out.println(a+b);                   // 얘는 overloading의 결과물이겠네여
    }

    public static void add(int a, String s){
        System.out.println("add(iont a, int String s)");
