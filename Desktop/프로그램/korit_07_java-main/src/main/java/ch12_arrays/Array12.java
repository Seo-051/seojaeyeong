...
//        System.out.println(num2);
        ...
        System.out.println("오름차순 정렬 전 배열 : "+ Arrays.toString(nums));

        // 오름 차순 정렬
        Arrays.sort(nums);          //얘의 결과겂이 void니까 원본 배열의 정렬을 함
        ...
        /*
            이상의 경우는 보면 sort() 메서드에 오름차순에서 argument가 하나였는데,
            ...
            char -> string 처럼 int -> Integer 라고만 생각해두시면 됨
         */
