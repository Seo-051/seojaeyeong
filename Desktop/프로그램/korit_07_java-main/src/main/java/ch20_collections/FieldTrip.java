...
/*
            ...
            1 번 학생의 수학 여행지를 입력하세여 >>> 제주
            2 번 학생의 수학 여행지를 입력하세여 >>> 제주
            3 번 학생의 수학 여행지를 입력하세여 >>> 민속촌
            4 번 학생의 수학 여행지를 입력하세여 >>> 민속촌
            5 번 학생의 수학 여행지를 입력하세여 >>> 제주
...
public class FieldTrip {
    public static void main(String[] args) {
        ...
        for(int i=0; i<student; i++){
            System.out.print((i+1) + " 번 학생의 수학 여행지를 입력하세여 >>> ");
            String TripName = scanner.nextLine();
            fieldTripsList.add(TripName);
        }
        System.out.println();
